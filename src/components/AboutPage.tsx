...
export default function AboutPage({ lang }: AboutPageProps) {
  ...
  const t = {
    ...
    intro: lang === 'cn' 
      ? 'RDI瑞国际照明设计（隶属于上海瑞逸环境设计有限公司）创立于2012年，是一家具有创新力的全球化专业照明顾问品牌。公司现已形成成熟的国际化服务布局，在上海、深圳、香港设立注册直营办公室，于纽约、新加坡设立海外办事处，搭建跨时区、跨地域高效协同网络。十余年来，团队凭借专业设计理念与扎实落地能力，业务版图覆盖亚洲、欧洲、北美洲等全球多地，持续获得多项国际照明设计奖项，是业内兼具综合实力、创新能力与国际口碑的专业照明设计机构。' 
    ...
    sec1Text: lang === 'cn'
      ? '专注全案照明设计，业务涵盖城市规划、地标建筑、商业综合体、高端酒店、文博艺术及高定住宅等多元领域，设计范畴贯通建筑、室内与景观全空间。我们坚持“美学表达与功能实用并行，艺术价值与生态节能兼顾”，以光为媒介，精准赋能城市空间，提升场景品质。'
    ...
    sec2Text1: lang === 'cn'
      ? 'RDI拥有一支高资质、复合型设计团队，核心成员包含照明专业博士、注册建筑师、国际认证照明设计师、及中国、亚洲、国际照明学会高级会员，团队累计获得百余项国内外设计奖项，专业底蕴深厚。成员涵盖建筑、室内、景观、戏剧灯光、艺术装置、新媒体艺术、工程落地等多学科背景，通过跨学科创意交融，突破传统照明设计边界，高效解决各类复杂项目设计难题。'
    ...
    sec2Text2: lang === 'cn'
      ? '依托国际化项目经验，公司长期与全球知名建筑大师及一线设计机构深度合作，合作大师包括David Alan Chipperfield、矶崎新、Jean Nouvel、Rem Koolhaas、Foster+Partners、Tadao Ando、Alvaro Siza等；长期合作事务所涵盖MAD、BIG、SOM、KPF、GP、Jerde、5+、Aedas、Benoy等国内外知名机构，同时与众多大型房企保持稳定战略合作，持续落地全球代表性光影项目。'
    ...
    sec3Text: lang === 'cn'
      ? '公司搭建完善的云端协同体系与标准化技术流程，依托跨区域智能协作平台，实现国内外站点无缝联动、跨时区高效配合，为全球客户提供统一、高效、高品质的设计服务。同时，团队持续以科技赋能设计创新，利用数字化设计、交互技术、人工智能技术支持方案创作、优化迭代、工程落地全流程，不断探索光的应用边界，打造兼具健康舒适、艺术创意、人文质感的优质光影空间。'
    ...
    sec4Text: lang === 'cn'
      ? 'RDI瑞国际照明设计始终秉持“以光为艺、以质为核、创新赋能、点亮城市”的核心理念，深耕光影艺术创新与绿色节能设计，专注平衡光与建筑、自然、城市人文的共生关系。未来，公司将持续深化全球化布局与科技化设计升级，依托跨学科团队与国际合作优势，持续输出高品质、前瞻性的照明设计成果，致力打造具备全球竞争力的照明设计专业品牌。'
